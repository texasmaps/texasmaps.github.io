...
WM.siteHTML=function(s,extra=''){const prec=s.precision==='site'?'the reported site':s.precision==='city'?'the city-center pin (exact parcel not published)':'the county-center pin (only the county is known)';
  ...
  <div class="actions"><a class="primary" href="texas_data_center_map.html#site=${encodeURIComponent(s.id)}">Open in Data Center Watch ↗</a><a href="https://www.google.com/maps/search/?api=1&query=${s.lat},${s.lon}" target="_blank" rel="noopener">Map ↗</a></div>
